...
LOG_FILE = "/var/log/bluetooth_pairing"
...
def writePidFile():
    pid = str(os.getpid())
    f = open('/var/run/bluetooth_pair.pid', 'w')
    f.write(pid)
    f.close()
...
class BlueAgent(dbus.service.Object):
    ...
    def trustDevice(self, path):
        ...
        logging.debug("BlueAgent is trusting device")
    ...
    def registerAsDefault(self):
        ...
        logging.debug("BlueAgent is registering as default")
